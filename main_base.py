...
from engine_base import evaluate, lvis_evaluate, train_one_epoch
...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='./r50_deformable_detr_plus_iterative_bbox_refinement_plus_plus_two_stage',help='path where to save, empty for no saving')
    parser.add_argument('--device', default='cuda',help='device to use for training / testing')
    parser.add_argument('--seed', default=42, type=int)
    parser.add_argument('--resume', default='', help='resume from checkpoint')
    parser.add_argument('--resume_backbone', default='')
    parser.add_argument('--start_epoch', default=0, type=int, metavar='N', help='start epoch')
    parser.add_argument('--eval', default=False, action='store_true')# True
    parser.add_argument('--num_workers', default=2, type=int)
    parser.add_argument('--cache_mode', default=False, action='store_true', help='whether to cache images on memory')
    parser.add_argument("--label_map", default=False, action="store_true")
    parser.add_argument('--freeze_weight', default=False, help='whether to freeze the weight')
    parser.add_argument('--lvis_version', default='1', help='lvis dataset version')
    parser.add_argument('--stage', default="full_train", type=str) # eval
...
def main(args):
    ...
    if args.resume:
        ...
        missing_keys, unexpected_keys = model_without_ddp.load_state_dict(checkpoint['model_l1'], strict=False)
